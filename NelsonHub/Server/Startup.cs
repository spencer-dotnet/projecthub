...
namespace NelsonHub.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<IWeatherService, WeatherService>(client => { client.DefaultRequestHeaders.UserAgent.ParseAdd("NelsonHub"); });

            services.AddTransient<INelsonHubSqlDataAccess, NelsonHubSqlDataAccess>();
